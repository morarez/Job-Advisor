...
public class SignUpJobSeekerController{
	 ...
	 private void presssubmit() throws IOException {
		 ...
		 { 
			 ...
			 boolean isValid = seeker.signUp(fname.getText(),lname.getText(),username.getText(),bday,gender.getText(),jpassword.getText(),jemail.getText(),jcity.getText(),jstate.getText(),skills.getText());
			 if(isValid==true)
